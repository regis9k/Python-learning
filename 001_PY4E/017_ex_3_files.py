# Exercise 3: Sometimes when programmers get bored or 
# want to have a bit of fun, they add a harmless Easter Egg 
# to their program. 
...
try:
    ...
    for i in fhandle:
        x=x+1
    print('There were',x,'subject lines in mbox.txt')
except:
